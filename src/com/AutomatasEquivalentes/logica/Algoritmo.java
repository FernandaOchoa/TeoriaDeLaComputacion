...
public class Algoritmo {
     ...
     * @param afdPC -> automata finito determinista que se esta comparando
     * @param ea -> estado actual del automata comparado
     * @param eaC-> estado actual del automata al que se compara
     * @return -> conjunto de estados igual al numero de simbolos del alfabeto
     */
    private String[] transicion(AFD afdPC, String ea, String eaC){
